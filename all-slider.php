<?php include"header.php"; ?>
	...
	*/
	...
	/* Get data. */
				...
				$result = $db->prepare("SELECT * FROM slider  ORDER BY id DESC LIMIT $start, $limit");
				$result->execute();
	 ...
	 ?>
               ...
               ?> 
							...
							<tr>
							  ...
							  <td><img src="../uploads/slider/<?php echo $row['file'];?>" alt="" class="img-responsive" style=" height:50px; width:50px;"></td>
							  <td>
							    <a href="delete-slider.php?id=<?=$row['id'] ?>" class="fa fa-eraser btn btn-xs btn-success warning_4 delbtn" >Delete</a>
